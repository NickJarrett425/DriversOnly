...
from members.models import UserProfile, SponsorUserProfile, DriverProfile, SponsorOrganization
def dashboard(request):
    ...
    if request.user.is_superuser:   
        ...
        return render(request, 'dashboard.html', {'Organization' : org, 'profile' : profile})
